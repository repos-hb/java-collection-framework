...
public class HashSetRemoveExample {
	...
	public static void main(String[] args) {
		...
		// Remove an element from a HashSet (The remove() method returns false
		// if the element does not exist in the HashSet)
		numbers.remove(7);
		System.out.println("After remove(7) => " + numbers);

		// Remove all elements belonging to a given collection from a HashSet
		List<Number> perfectSquares = new ArrayList<>();
